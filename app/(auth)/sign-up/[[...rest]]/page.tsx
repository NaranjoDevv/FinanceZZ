  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 hidden sm:block">
        <motion.div
          className="absolute top-32 right-20 w-5 h-5 bg-black"
          animate={{ rotate: -360 }}
          transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
        />
        <motion.div
          className="absolute bottom-40 left-24 w-8 h-8 border-4 border-black"
          animate={{ scale: [1, 1.3, 1] }}
          transition={{ duration: 4, repeat: Infinity }}
        />
        <motion.div
          className="absolute top-1/3 right-16 w-3 h-12 bg-black"
          animate={{ y: [-15, 15, -15] }}
          transition={{ duration: 3.5, repeat: Infinity }}
        />
        <motion.div
          className="absolute top-20 left-1/2 w-10 h-3 bg-black"
          animate={{ x: [-25, 25, -25] }}
      ...
      <div className="absolute inset-0 sm:hidden">
        <div className="absolute top-4 left-4 w-3 h-3 bg-black" />
        <div className="absolute bottom-4 right-4 w-2 h-8 bg-black" />
        <div className="absolute top-1/4 left-8 w-6 h-1 bg-black" />
      </div>
      ...
      >
        ...
        >
          <h1 className="text-4xl sm:text-6xl font-black text-black mb-4 sm:mb-6 tracking-tighter uppercase pt-8 sm:pt-16">
            FINANCEZZ
          </h1>
